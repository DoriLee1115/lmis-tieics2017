...
public class ShipperRestController {
    ...
    public ResponseEntity<Void> create(Shipper shipper, UriComponentsBuilder ucBuilder) {
    ...
    public ResponseEntity<Shipper> update(@PathVariable("id") String id, Shipper shipper) {
