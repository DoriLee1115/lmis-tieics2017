...
public class CarrierRestController {
    ...
    public ResponseEntity<Void> create(Carrier carrier, UriComponentsBuilder ucBuilder) {
    ...
    public ResponseEntity<Carrier> update(@PathVariable("id") String id, Carrier carrier) {
